...
optCutOff <- optimalCutoff(test.FD001$class_label, as.numeric(basic_classtree_predictions),optimiseFor = "misclasserror")[1] 

# show confusion matrix
confusionMatrix(test.FD001$class_label, as.numeric(basic_classtree_predictions), threshold = optCutOff)

#check how many failures were missed
sensitivity <- sensitivity(test.FD001$class_label,as.numeric(basic_classtree_predictions), threshold = optCutOff)
