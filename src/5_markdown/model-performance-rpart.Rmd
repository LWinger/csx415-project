...
rmse <- rmse(most_recent_test$ground_truth_rul, basic_regtree_predictions)

#check how many predictions were late
#if negative then late
error <- most_recent_test$ground_truth_rul - basic_regtree_predictions
...
optCutOff <- optimalCutoff(most_recent_test$class_label, as.numeric(basic_classtree_predictions[,2]),optimiseFor = "misclasserror")[1] 
...
sensitivity <- sensitivity(most_recent_test$class_label,as.numeric(basic_classtree_predictions[,2]), threshold = optCutOff)
